...
(function() {
  ...
  */
  ...
  create_dashboards = function() {
    ...
    return deferred.done(function(result) {
      var item, metric, part, parts, these_metrics, this_dashboard, _i, _len;
      this_dashboard = {
        name: "Timers",
        description: "Random timing data"
      };
      result = (function() {
      ...
      result = (function() {
        ...
        for (_i = 0, _len = result.length; _i < _len; _i++) {
          item = result[_i];
          _results.push((item.split(".")).slice(0, -1).join("."));
        }
        return _results;
      })();
