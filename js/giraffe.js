...
(function() {
  ...
  */
  ...
  make_dashboard = function(namespace, timers) {
  ...
  create_dashboards = function() {
    ...
    return deferred.done(function(result) {
      var item, k, key, namespace_dict, this_dashboard, v, value, _i, _len, _ref;
      result = (function() {
      ...
      for (k in namespace_dict) {
        if (!__hasProp.call(namespace_dict, k)) continue;
        v = namespace_dict[k];
